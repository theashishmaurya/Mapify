...
const Privacy = () => {
  return (
    <div className=" mx-40">
      <h1>Privacy Policy for Mapify</h1>

      <p>
        At Mapify, accessible from https://mapify.vercel.app, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Mapify
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Mapify. This policy is not applicable to any
      ...
      <p>
        Mapify follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Mapify uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of Mapify.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Mapify, which are sent directly
      ...
      <p>
        Note that Mapify has no access to or control over these cookies that are
      ...
      <p>
        Mapify's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Mapify does not knowingly collect any Personal Identifiable Information
